# ⚔️ Git Workshop Challenge

### Hello Coding Cougs!

Your mission is to use your Git skills to rewrite history. Below is a tale of a knight whose journey did not go as planned. Your task is to change the **bolded words** to ensure Sir Cedric succeeds in his quest.
...
>
> He was **blessed** by the forest's magic and **uncontested** by the dragon guarding the cave.
>
> Having **completed** his mission, he returned to the castle in **glory**.
>
> The King was **pleased**, and Cedric's **victory** was **celebrated** by the court.
